import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, createElementBlock, openBlock, createElementVNode, inject, ref, computed, getCurrentInstance, unref, provide, watch, hasInjectionContext, isRef, warn, nextTick, normalizeClass, renderSlot, normalizeStyle, useSlots, reactive, toRef, createBlock, resolveDynamicComponent, mergeProps, withCtx, createCommentVNode, Fragment, h, Transition, withDirectives, createVNode, vShow, createApp, toRefs, Text, Suspense, shallowRef, cloneVNode, useSSRContext, shallowReactive, createTextVNode, onErrorCaptured, onServerPrefetch, effectScope, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, getCurrentScope } from 'vue';
import { k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, $ as $fetch, p as createHooks, q as executeAsync, f as createError$1, t as toRouteMatcher, v as createRouter$1, x as defu } from '../nitro/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { computedEager, isClient } from '@vueuse/core';
import { isString, isObject, NOOP, hasOwn, hyphenate, camelize, isFunction, isArray } from '@vue/shared';
import { fromPairs, isNil, set, get } from 'lodash-unified';
import { ssrRenderComponent, ssrGetDirectiveProps, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead_EAnnASrRNrJ4usi6hWRIAhvC9AVbE_KoWkf_v5HF1Lc = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DePaPOl0.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DLDSCGr5.mjs')
  }
];
...
const revive_payload_server_Cp2nkwEKfhnNfrVC_hw_KPogbe0rtj1bLI7YXoJNdz0 = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_EAnnASrRNrJ4usi6hWRIAhvC9AVbE_KoWkf_v5HF1Lc,
  plugin,
  revive_payload_server_Cp2nkwEKfhnNfrVC_hw_KPogbe0rtj1bLI7YXoJNdz0,
...
var Container = /* @__PURE__ */ _export_sfc$1(_sfc_main$a, [["__file", "container.vue"]]);
...
var Aside = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["__file", "aside.vue"]]);
...
var Footer = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["__file", "footer.vue"]]);
...
var Header = /* @__PURE__ */ _export_sfc$1(_sfc_main$7, [["__file", "header.vue"]]);
...
var Main = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["__file", "main.vue"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const login = () => {
      (void 0).localStorage.setItem("yuque_token", "");
      router.push({
        path: "login"
      });
    };
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(route).name !== "login") {
              _push2(ssrRenderComponent(_component_el_header, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-fec1111a${_scopeId2}><span data-v-fec1111a${_scopeId2}>语雀批量导出</span><a href="https://github.com/web-farmer/yuque-exporter" title="GitHub" target="_blank" class="iconfont icon-github" data-v-fec1111a${_scopeId2}></a></div>`);
                    if (unref(route).name !== "login") {
            ...
            _push2(ssrRenderComponent(_component_el_main, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="el-page-main" data-v-fec1111a${_scopeId2}>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fec1111a"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DU8ilfgL.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CJpWTiYI.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.25_db0@0.3.4_esli_4q4hvhr3sdssveeamcmttkqsba/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.25_db0@0.3.4_esli_4q4hvhr3sdssveeamcmttkqsba/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { TypeComponentsMap as $, addClass as A, loading_default as B, caret_right_default as C, iconPropType as D, ElIcon as E, useLocale as F, formItemContextKey as G, throwError as H, addUnit as I, vLoading as J, ElContainer as K, ElAside as L, ElMain as M, download_default as N, circle_close_default as O, view_default as P, hide_default as Q, useGlobalConfig as R, formContextKey as S, useId as T, getProp as U, ValidateComponentsMap as V, ElButton as W, useEmptyValuesProps as X, provideGlobalConfig as Y, useGlobalComponentSettings as Z, _export_sfc as _, useNuxtApp as a, TypeComponents as a0, isElement as a1, withInstallFunction as a2, useRuntimeConfig as b, nuxtLinkDefaults as c, isUndefined as d, entry_default as default, isPropAbsent as e, _export_sfc$1 as f, useNamespace as g, isNumber as h, isBoolean as i, useSizeProp as j, useFormDisabled as k, useFormItem as l, debugWarn as m, navigateTo as n, useFormSize as o, useFormItemInputId as p, useDeprecated as q, resolveRouteObject as r, buildProps as s, tryUseNuxtApp as t, useRouter as u, definePropType as v, withInstall as w, withNoopInstall as x, componentSizes as y, removeClass as z };
