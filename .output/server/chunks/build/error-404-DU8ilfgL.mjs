...
import { y as parseQuery, k as hasProtocol, m as joinURL, z as withTrailingSlash, A as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
import { u as useHead } from './v3-DzwXlnbW.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-8a077838><div class="fixed left-0 right-0 spotlight z-10" data-v-8a077838></div><div class="max-w-520px text-center z-20" data-v-8a077838><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-8a077838>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-8a077838>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-8a077838>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.25_db0@0.3.4_esli_4q4hvhr3sdssveeamcmttkqsba/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a077838"]]);

export { error404 as default };
//# sourceMappingURL=error-404-DU8ilfgL.mjs.map
